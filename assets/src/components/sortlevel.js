...
const levels = [
  { id: 1, name: 'Level 1', screen: 'Sort' },
  { id: 2, name: 'Level 2', screen: 'Sort1' },
  { id: 3, name: 'Level 3', screen: 'Sort2' },
];

const SortLevelSelectorScreen = () => {
...
export default SortLevelSelectorScreen;
